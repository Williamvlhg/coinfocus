        ...
        limitOrders.forEach((order) => {
          ...
          if (
            ...
            setLimitOrders((prevOrders) =>
              prevOrders.filter((o) => o !== order)
            );
            alert(`Ordre limité exécuté : ${type.toUpperCase()} ${crypto} à $${currentPrice}`);
          }
        });
      }, [prices])
    ...
    return (
      <div className="trading-page">
        ...
        <div className="trading-main">
          ...
          <div className="portfolio"> <Portfolio balance={balance} holdings={holdings} prices={prices}/></div>
